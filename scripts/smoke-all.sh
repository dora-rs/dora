...
log_skip "cxx-thread-safe-output" "C++ compiler (run by the nightly examples job)"
log_skip "cxx-thread-safe-output-bench" "manual measurement tool, not a smoke test"
