...
| Every example dataflow end-to-end (~15-20 min) | `make qa-examples` | orthogonal to ladder; wraps `scripts/smoke-all.sh`. qa-fast/full/deep `--exclude dora-examples` by design |
