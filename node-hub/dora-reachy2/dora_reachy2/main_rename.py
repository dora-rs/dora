...
reachy.l_arm._goto_joints(
    action[0:7], duration=2.0, degrees=False, interpolation_mode="minimum_jerk"
)
reachy.r_arm._goto_joints(
    action[8:15], duration=2.0, degrees=False, interpolation_mode="minimum_jerk"
)

reachy.cameras.depth.pixel_to_world
