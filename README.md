...
| Large Language Model (LLM)    | [Qwen2.5](https://github.com/dora-rs/dora/blob/main/node-hub/) | ✅     | Large Language Model using Qwen                  | ![Downloads](https://img.shields.io/pypi/dm/dora-qwen?label=%20)      | ![License](https://img.shields.io/pypi/l/dora-qwen?label=%20)     |
| Large Language Model (LLM)    | [mlx-lm](https://github.com/dora-rs/dora/blob/main/node-hub/)  | ✅     | Large Language Model using mlx-lm          |        |           |      |
