...
| Large Language Model(LLM)     | [Qwen2.5](https://github.com/dora-rs/dora/blob/main/node-hub/dora-qwen)                             | ✅                  | Large Language Model using Qwen                  | ![Downloads]
| Large Language Model(LLM)     | [mlx-lm](https://github.com/dora-rs/dora/blob/main/node-hub/mlx-lm)                                  | ✅                  | Large Language Model using mlx-lm                | ![Downloads](https://img.shields.io/pypi/dm/dora-mlx-lm?label=%20)            | ![License](https://img.shields.io/pypi/l/dora-mlx-lm?label=%20)            |
(https://img.shields.io/pypi/dm/dora-qwen?label=%20)              | ![License](https://img.shields.io/pypi/l/dora-qwen?label=%20)              |
